...
function Pagination({
  ...
  return (
    <div className="w-full flex flex-col sm:flex-row mt-4 items-center gap-3 ">
      {/* SHOWING ITEMS COUNT */}
      ...
      <div className="flex items-center justify-center gap-2">
        ...
        <ReactPagination
          ...
          activeClass={"!bg-primaryColor text-white rounded-lg"}
          itemClass={
            "cursor-pointer w-[30px] h-[30px] text-[13px] 2xl:w-[35px] 2xl:h-[35px] 2xl:text-[15px] text-center text-primaryColor flex justify-center items-center"
          }
